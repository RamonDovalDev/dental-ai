  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden bg-linear-to-b from-background via-muted/3 to-background">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-linear-to br from-background via-muted/5 to-primary/10">
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        {/* Pricing Cards */}
        <div className="grid lg:grid-cols-3 max-w-6xl mx-auto gap-8">
          {/* Free Plan */}
          <div className="relative group">
            <div className="relative bg-linear-to-br from-card/90 to-card/80 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon />
                    <span>Unlimited appointment booking</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon />
                    <span>Find dentists in your area</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon />
                    <span>Basic text chat support</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon />
